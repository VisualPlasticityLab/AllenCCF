...
% curr_slice=1 %JS temporary modification
for curr_slice = 1:numel(gui_data.slice_im)
...
switch eventdata.Key
    ...
    case 'space'
        ...
        set(gui_data.histology_aligned_atlas_boundaries,'Visible', ...
         ...
         case 's'
        save_fign = [gui_data.slice_im_path filesep 'alignedimg'];
        saveas(gcf,[save_fign 'annotaed.jpg']);
        fprintf(['Saved:' save_fign 'annotaed.jpg']);
end
...
set(gui_data.histology_aligned_atlas_boundaries, ...
    ...
    'AlphaData',av_warp_boundaries*0.9);
