...
switch eventdata.Key
    ...
    case 's'
        ...
        disp(['Saved ' save_fn]);
        save_fign = [gui_data.slice_im_path filesep 'alignedimg' num2str(gui_data.curr_slice)];
%         savefig(save_fign);
        saveas(gcf,[save_fign '.jpg']);
...
set(gui_data.histology_aligned_atlas_boundaries, ...
    ...
    'AlphaData',av_warp_boundaries*0.5);
